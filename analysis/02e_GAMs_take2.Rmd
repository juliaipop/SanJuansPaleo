...
mod_d13C_TRK <- gamm(d13C ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = TRK_short,
                     method = "REML")
...
mod_perC_TRK <- gamm(percent.C ~ s(year_plot_extrap, k = 10), 
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perN_TRK <- gamm(percent.N ~ s(year_plot_extrap, k = 10), 
                     family=Gamma(link="log"),  
                     data = TRK_short,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_pheoa_TRK <- gamm(pheo_a_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = TRK_short,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_diato_TRK <- gamm(diato_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = TRK_short,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_allo_TRK <- gamm(allo_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = TRK_short,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_cyanos_TRK <- gamm(cyanos ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = TRK_short,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_d15N_LFM_CAR1_ex <- gamm(d15N ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = LFM_short_extrap,
                     correlation = corCAR1(form = ~ year_plot_extrap),
                     method = "REML")
...
resid_values_ex <- residuals(mod_d15N_LFM$lme, type = "normalized")       # no CAR(1)
...
## summary object for use in document
d15NSumm_LFM_ex <- summary(mod_d15N_LFM$gam)
...
d15NYear_LFM_ex <- cbind(d15NYear_LFM_ex,
                      data.frame(predict(mod_d15N_LFM$gam, d15NYear_LFM_ex,
                                         type="response", se.fit = TRUE)))
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_d13C_LFM <- gamm(d13C ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = LFM_short_extrap,
                     method = "REML")
...
## Plot fitted trends
ggplot(d13CYear_LFM, aes(x = year_plot_extrap, y = fit)) +
  geom_ribbon(aes(ymin = (lower),
                  ymax = (upper), x = year_plot_extrap),
              alpha = 0.2, inherit.aes = FALSE, fill = "black") +
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perC_LFM <- gamm(percent.C ~ s(year_plot_extrap, k = 10), 
                     family=Gamma(link="log"),  
                     data = LFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perN_LFM <- gamm(percent.N ~ s(year_plot_extrap, k = 10), 
                     family=Gamma(link="log"),  
                     data = LFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_CN_LFM <- gamm(C.N ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = LFM_short_extrap,
                   #  correlation = corCAR1(form = ~ year_plot_extrap),
                     method = "REML")
...
mod_pheoa_LFM <- gamm(pheo_a_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = LFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_greens_LFM <- gamm(greens ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = LFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_diato_LFM <- gamm(diato_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = LFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_allo_LFM <- gamm(allo_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = LFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_cyanos_LFM <- gamm(cyanos ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = LFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_d13C_UFM <- gamm(d13C ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = UFM_short_extrap,
                     method = "REML")
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perC_UFM <- gamm(percent.C ~ s(year_plot_extrap, k = 10), 
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perN_UFM <- gamm(percent.N ~ s(year_plot_extrap, k = 10), 
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_CN_UFM <- gamm(C.N ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = UFM_short_extrap,
                   #  correlation = corCAR1(form = ~ year_plot_extrap),
                     method = "REML")
...
mod_pheoa_UFM <- gamm(pheo_a_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_greens_UFM <- gamm(greens ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_diato_UFM <- gamm(diato_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_allo_UFM <- gamm(allo_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_cyanos_UFM <- gamm(cyanos ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
