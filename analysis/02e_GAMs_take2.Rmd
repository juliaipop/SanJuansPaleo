...
#Row 1 
( LFM_percC + theme(axis.title.x=element_blank(),
                    axis.text.x=element_blank())) +
            (UFM_percC + theme(axis.title.y=element_blank(),
                               axis.title.x=element_blank(),
                               axis.text.x=element_blank()))  + 
            (TRK_percC + theme(axis.title.y=element_blank(),
                               axis.title.x=element_blank(),
                               axis.text.x=element_blank())) + 

#Row 2
( LFM_percN + theme(axis.title.x=element_blank(),
                    plot.title = element_blank(),
                    axis.text.x=element_blank())) + 
  (UFM_percN + theme(axis.title.y=element_blank(),
                               axis.title.x=element_blank(),
                               plot.title = element_blank(),
                     axis.text.x=element_blank())) + 
              (TRK_percN + theme(axis.title.y=element_blank(),
                               axis.title.x=element_blank(),
                               plot.title = element_blank(),
                               axis.text.x=element_blank())) + 
#Row 3
...
plot_layout(guides = 'collect') +  # a single legend 
  plot_annotation(tag_levels = 'a') & # https://patchwork.data-imaginist.com/articles/guides/annotation.html
