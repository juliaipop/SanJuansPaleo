...
# try with and without corCAR1, then examine the residuals. 
mod_d15N_UFM <- gam(d15N ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
...
mod_d13C_UFM <- gam(d13C ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = UFM_short_extrap,
                     method = "REML")
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perC_UFM <- gam(percent.C ~ s(year_plot_extrap, k = 10), 
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perN_UFM <- gam(percent.N ~ s(year_plot_extrap, k = 10), 
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_CN_UFM <- gam(C.N ~ s(year_plot_extrap, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = UFM_short_extrap,
                   #  correlation = corCAR1(form = ~ year_plot_extrap),
                     method = "REML")
...
mod_pheoa_UFM <- gam(pheo_a_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_greens_UFM <- gam(greens ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_diato_UFM <- gam(diato_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_allo_UFM <- gam(allo_nmol_gTC ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
...
mod_cyanos_UFM <- gam(cyanos ~ s(year_plot_extrap, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short_extrap,
                     # REML only works for gaussian data
                     method = "ML")
