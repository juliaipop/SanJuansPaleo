...
#Highlight area with most reliable dates
highlight_data <- tibble(xmin = 1929, xmax = 2025, ymin = -Inf, ymax = Inf)
...
(LFM_perN + theme(axis.title.x=element_blank(),
  ...
  (UFM_perN + theme(axis.title.y=element_blank(),
              ...
              (TRK_perN + theme(axis.title.y=element_blank(),
                               ...
                               axis.text.x=element_blank())) + 
# Row 3
(LFM_CN + theme(axis.title.x=element_blank(),
                    plot.title = element_blank(),
                    axis.text.x=element_blank())) + 
  (UFM_CN + theme(axis.title.y=element_blank(),
                  plot.title = element_blank(),
                  axis.title.x=element_blank(),
                  axis.text.x=element_blank()))  + 
  (TRK_CN + theme(axis.title.y=element_blank(),
                 plot.title = element_blank(),
                 axis.text.x=element_blank(), 
                 axis.title.x=element_blank()))  + 
