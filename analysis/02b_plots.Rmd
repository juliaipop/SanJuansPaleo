...
## GREEBS Pigment Plots (but with fluxes instead now!)
```{R}
...
```{r}
library(dplyr)
subset_lakes <- all_lakes %>%
  filter(sample_ID %in% c("LFM2_010", "LFM2_020", "LFM2_044", "UFM1_014", "UFM1_030", "UFM1_044", "TRK2_010", "TRK2_030", "TRK2_070")) %>%
  select(sample_ID, percent.C)
