...
View(select(UFM_short_extrap, c(depth_plot, year_plot_extrap, year_CE_plot, percent.N)))
View(select(LFM_short_extrap, c(depth_plot, year_plot_extrap, year_CE_plot, percent.N)))
