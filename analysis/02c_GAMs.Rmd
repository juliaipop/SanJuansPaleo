...
```
## d15N
Use UFM_short. Columns are the same (year_CE_plot for interp and extrap for extrapolated)
```{r}

### K (sets the maximum # of bases for our spline): 
# Our dataset is still small: rule of thumb is to not let k approach n
    # how much data are we working with? 
    sum(!is.na(UFM_short$year_CE_plot)) # 10 observations... not so many
    sum(!is.na(UFM_short$year_plot_extrap)) # 41 observations. 

# try with and without corCAR1, then examine the residuals. 
mod_d15N_UFM <- gamm(d15N ~ s(year_CE_plot, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = UFM_short,
                     method = "REML")
...
## Plot fitted trends
ggplot(d15NYear_UFM, aes(x = year_CE_plot, y = fit)) +
  geom_ribbon(aes(ymin = (lower),
                  ymax = (upper), x = year_CE_plot),
              alpha = 0.2, inherit.aes = FALSE, fill = "black") +
  geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = d15N), inherit.aes = FALSE) +
  geom_line() 
...
## d13C
Use UFM_short to be able to plot all the data vs. time, but model only the interpolated dates. 
```{r}

# check later how weights, corCAR1 compare. 
    
mod_d13C_UFM <- gamm(d13C ~ s(year_CE_plot, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = UFM_short,
                     method = "REML")

summary(mod_d13C_UFM$lme) # using REML - good.

resid_values_d13C_UFM <- residuals(mod_d13C_UFM$lme, type = "normalized")
acf(resid_values_d13C_UFM) # has neg lag

## summary object for use in document
d13CSumm_UFM <- summary(mod_d13C_UFM$gam)
d13CSumm_UFM #Gives you the P values, degrees of freedom...

### Check diagnostics. You might need to adjust model
gam.check(mod_d13C_UFM$gam)
...
# Second, if you're only concerned about the response, include "response" in type of predict()???
d13CYear_UFM <- with(UFM_short, 
                     data.frame(year_CE_plot = seq(min(year_CE_plot, na.rm=TRUE), max(year_CE_plot, na.rm=TRUE), length.out = 200)))

d13CYear_UFM <- cbind(d13CYear_UFM,
                      data.frame(predict(mod_d13C_UFM$gam, d13CYear_UFM,
                                         type="response", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(d13CYear_UFM, aes(x = year_CE_plot, y = fit)) +
  geom_ribbon(aes(ymin = (lower),
                  ymax = (upper), x = year_CE_plot),
              alpha = 0.2, inherit.aes = FALSE, fill = "black") +
  geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = d13C), inherit.aes = FALSE) +
  geom_line() 
...
# breaks = ?
  hist(UFM_short$percent.C)
  hist(log(UFM_short$percent.C))
  
# check later how weights, corCAR1 compare. 
    
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perC_UFM <- gamm(percent.C ~ s(year_CE_plot, k = 10), 
                     family=Gamma(link="log"),  
                     data = UFM_short,
                     # REML only works for gaussian data
                     method = "ML")

summary(mod_perC_UFM$lme) # using ML because of the Gamma family designation

resid_values_perC_UFM <- residuals(mod_perC_UFM$lme, type = "normalized")
acf(resid_values_perC_UFM) # acf looks good

## summary object for use in document
perCSumm_UFM <- summary(mod_perC_UFM$gam)
perCSumm_UFM #Gives you the P values, degrees of freedom...

### Check diagnostics. You might need to adjust model
gam.check(mod_perC_UFM$gam)
...
perCYear_UFM <- cbind(perCYear_UFM,
                      data.frame(predict(mod_perC_UFM$gam, perCYear_UFM,
                                         type="link", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(perCYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = percent.C), inherit.aes = FALSE) +
      geom_line() 
...
```{r}
  ...
  hist(UFM_short$percent.N)
  hist(log(UFM_short$percent.N))


# check later how weights, corCAR1 compare. 
    
# drop the "ex" for simplicity now that we know the dataset shouldn't affect the outcomes. 
mod_perN_UFM <- gamm(percent.N ~ s(year_CE_plot, k = 10), 
                     family=Gamma(link="log"),  
                     data = UFM_short,
                     # REML only works for gaussian data
                     method = "ML")

summary(mod_perN_UFM$lme) # using ML because of the Gamma family designation

resid_values_perN_UFM <- residuals(mod_perN_UFM$lme, type = "normalized")
acf(resid_values_perN_UFM) 
# negative response at lag 1

## summary object for use in document
perNSumm_UFM <- summary(mod_perN_UFM$gam)
perNSumm_UFM #Gives you the P values, degrees of freedom...

### Check diagnostics. You might need to adjust model
gam.check(mod_perN_UFM$gam)
...
perNYear_UFM <- cbind(perNYear_UFM,
                      data.frame(predict(mod_perN_UFM$gam, perNYear_UFM,
                                         type="link", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(perNYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = percent.N), inherit.aes = FALSE) +
      geom_line() 
...
```{r}
# this column name is annoying so change it to match LFM
UFM_short <- rename(UFM_short, C.N = `C:N`)
names(UFM_short)

# check later how weights, corCAR1 compare. 
    
  hist(UFM_short$C.N)
  hist(log(UFM_short$C.N))
  # data is left skewed, log transform makes it worse? in this case it looks a little better?
    
mod_CN_UFM <- gamm(C.N ~ s(year_CE_plot, k = 10), 
                     family = gaussian(link = "identity"), 
                     data = UFM_short,
                   #  correlation = corCAR1(form = ~ year_CE_plot),
                     method = "REML")
...
AIC(mod_CN_UFM$lme) 
summary(mod_CN_UFM$lme)

### Check diagnostics. You might need to adjust model
gam.check(mod_CN_UFM$gam)

# p value too low if you change anything (add car 1 etc.)

    resid_values_CN_UFM <- residuals(mod_CN_UFM$lme, type = "normalized")
    acf(resid_values_CN_UFM) 
    # residuals significant, def structured, corCAR1 helps a little but sample size is too small to use it.
    
## summary object for use in document
CNSumm_UFM <- summary(mod_CN_UFM$gam)
...
CNYear_UFM <- cbind(CNYear_UFM,
                      data.frame(predict(mod_CN_UFM$gam, CNYear_UFM,
                                         type="response", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(CNYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = C.N), inherit.aes = FALSE) +
      geom_line() 
...
```{r}
# compare data distributions
  hist(UFM_short$pheo_a_nmol_gTC)
  hist(log(UFM_short$pheo_a_nmol_gTC)) # better!

    # check later how weights, corCAR1 compare. 
    
mod_pheoa_UFM <- gamm(pheo_a_nmol_gTC ~ s(year_CE_plot, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short,
                     # REML only works for gaussian data
                     method = "ML")
...
summary(mod_pheoa_UFM$lme) # using ML because of the Gamma family designation

resid_values_pheoa_UFM <- residuals(mod_pheoa_UFM$lme, type = "normalized")
acf(resid_values_pheoa_UFM) # looks good!

## summary object for use in document
pheoaSumm_UFM <- summary(mod_pheoa_UFM$gam)
pheoaSumm_UFM #Gives you the P values, degrees of freedom...

### Check diagnostics. You might need to adjust model
gam.check(mod_pheoa_UFM$gam)
...
pheoaYear_UFM <- cbind(pheoaYear_UFM,
                      data.frame(predict(mod_pheoa_UFM$gam, pheoaYear_UFM,
                                         type="link", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(pheoaYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = pheo_a_nmol_gTC), inherit.aes = FALSE) +
      geom_line() 
...
```{r}
# compare data distributions
  hist(UFM_short$greens)
  hist(log(UFM_short$greens)) # log is better

    # check later how weights, corCAR1 compare. 
    
mod_greens_UFM <- gamm(greens ~ s(year_CE_plot, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short,
                     # REML only works for gaussian data
                     method = "ML")
...
summary(mod_greens_UFM$lme) # using ML because of the Gamma family designation

resid_values_greens_UFM <- residuals(mod_greens_UFM$lme, type = "normalized")
acf(resid_values_greens_UFM) # looks good!

## summary object for use in document
greensSumm_UFM <- summary(mod_greens_UFM$gam)
...
greensYear_UFM <- cbind(greensYear_UFM,
                      data.frame(predict(mod_greens_UFM$gam, greensYear_UFM,
                                         type="link", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(greensYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = greens), inherit.aes = FALSE) +
      geom_line() 
...
# compare data distributions
  hist(UFM_short$diato_nmol_gTC)
  hist(log(UFM_short$diato_nmol_gTC)) # log transformation is rly helpful

    # check later how weights, corCAR1 compare. 
    
mod_diato_UFM <- gamm(diato_nmol_gTC ~ s(year_CE_plot, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short,
                     # REML only works for gaussian data
                     method = "ML")

summary(mod_diato_UFM$lme) # using ML because of the Gamma family designation

resid_values_diato_UFM <- residuals(mod_diato_UFM$lme, type = "normalized")
acf(resid_values_diato_UFM) # same negative acf right at lag 1, not huge though

## summary object for use in document
diatoSumm_UFM <- summary(mod_diato_UFM$gam)
diatoSumm_UFM #Gives you the P values, degrees of freedom...

### Check diagnostics. You might need to adjust model
gam.check(mod_diato_UFM$gam)
...
diatoYear_UFM <- cbind(diatoYear_UFM,
                      data.frame(predict(mod_diato_UFM$gam, diatoYear_UFM,
                                         type="link", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(diatoYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = diato_nmol_gTC), inherit.aes = FALSE) +
      geom_line() 
...
# compare data distributions
  hist(UFM_short$allo_nmol_gTC)
  hist(log(UFM_short$allo_nmol_gTC)) # log transformation not that helpful but use it out of principle? 

    # check later how weights, corCAR1 compare. 
    
mod_allo_UFM <- gamm(allo_nmol_gTC ~ s(year_CE_plot, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short,
                     # REML only works for gaussian data
                     method = "ML")

summary(mod_allo_UFM$lme) # using ML because of the Gamma family designation

resid_values_allo_UFM <- residuals(mod_allo_UFM$lme, type = "normalized")
acf(resid_values_allo_UFM) # looks good!

## summary object for use in document
alloSumm_UFM <- summary(mod_allo_UFM$gam)
alloSumm_UFM #Gives you the P values, degrees of freedom...

### Check diagnostics. You might need to adjust model
gam.check(mod_allo_UFM$gam)
...
alloYear_UFM <- cbind(alloYear_UFM,
                      data.frame(predict(mod_allo_UFM$gam, alloYear_UFM,
                                         type="link", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(alloYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = allo_nmol_gTC), inherit.aes = FALSE) +
      geom_line() 
...
# compare data distributions
  hist(UFM_short$cyanos)
  hist(log(UFM_short$cyanos)) # log transformation is rly helpful

    # check later how weights, corCAR1 compare. 
    
mod_cyanos_UFM <- gamm(cyanos ~ s(year_CE_plot, k = 10),
                     family=Gamma(link="log"),  
                     data = UFM_short,
                     # REML only works for gaussian data
                     method = "ML")

summary(mod_cyanos_UFM$lme) # using ML because of the Gamma family designation

resid_values_cyanos_UFM <- residuals(mod_cyanos_UFM$lme, type = "normalized")
acf(resid_values_cyanos_UFM) # looks good

## summary object for use in document
cyanosSumm_UFM <- summary(mod_cyanos_UFM$gam)
cyanosSumm_UFM #Gives you the P values, degrees of freedom...

### Check diagnostics. You might need to adjust model
gam.check(mod_cyanos_UFM$gam)
...
cyanosYear_UFM <- cbind(cyanosYear_UFM,
                      data.frame(predict(mod_cyanos_UFM$gam, cyanosYear_UFM,
                                         type="link", se.fit = TRUE)))
...
## Plot fitted trends
ggplot(cyanosYear_UFM, aes(x = year_CE_plot, y = fit)) + # year_CE_plot is the interp time var
geom_ribbon(aes(ymin = (lower),
                ymax = (upper), x = year_CE_plot),
            alpha = 0.2, inherit.aes = FALSE, fill = "black") +
      geom_point(data = UFM_short, mapping = aes(x = year_plot_extrap, y = cyanos), inherit.aes = FALSE) +
      geom_line() 
