...
# plot it so age is on the y axis
plot(year_plot_extrap ~ depth_plot, data = TRK_short, type = "l",
     xlab = "Depth (cm)", ylab = "Year CE")
points(TRK_short$depth_plot,TRK_short$year_plot_extrap, pch = 20, cex = 0.3)
abline(h = 1982.209, lty = "aa")
